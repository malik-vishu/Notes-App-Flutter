...
Note _noteDeserialize(
  ...
  final object = Note(
    color: reader.readStringOrNull(offsets[0]) ?? "White",
...
P _noteDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? "White") as P;
    case 1:
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'desc',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'desc',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'desc',
        value: '',
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> descIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'desc',
        value: '',
...
extension NoteQuerySortBy on QueryBuilder<Note, Note, QSortBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> sortByDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'desc', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> sortByDescDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQuerySortThenBy on QueryBuilder<Note, Note, QSortThenBy> {
  ...
  QueryBuilder<Note, Note, QAfterSortBy> thenByDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'desc', Sort.asc);
    });
  }

  QueryBuilder<Note, Note, QAfterSortBy> thenByDescDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'desc', Sort.desc);
    });
  }
...
extension NoteQueryWhereDistinct on QueryBuilder<Note, Note, QDistinct> {
  ...
  QueryBuilder<Note, Note, QDistinct> distinctByDesc(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, String, QQueryOperations> descProperty() {
    return QueryBuilder.apply(this, (query) {
